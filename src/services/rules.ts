 ...
 * (`backend/src/utils/password.js` và `backend/src/utils/validateInput.js`). Để
 ...
 * không ra.
 *
 * Bản sao của `chuanHoaSoDienThoai` trong `backend/src/utils/phoneNumber.js` —
 ...
 * trong `backend/src/utils/loginIdentifier.js`; sửa ở đây thì phải sửa cả
 * bên kia.
 *
